...
import { TrashFill, PencilSquare } from 'react-bootstrap-icons'; // icons
    ...
    <div>
        ...
        <Col className="d-flex me-5">
          {review.user && (
            <>
              ...
              <div className="cat-text p-1 pt-2">{review.title}</div>
            </>
          )}
        </Col>
      </Row>
      <Row className="border-bottom mx-2">
        <Col className="d-flex me-4 pb-2">
          <div className="rate-description d-inline ms-2"></div>
          {isUser && (
